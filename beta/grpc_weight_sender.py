...
# Import the generated protobuf modules from Gamma's phase2 directory.
# In the integrated repo, these are shared between teams.
sys.path.insert(0, str(Path(__file__).resolve().parent.parent / "gama" / "phase2"))
